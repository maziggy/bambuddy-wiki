...
|--------|--------|:------:|
| **H2 Series** | H2C, H2D, H2S | :material-check-circle:{ .text-green } Tested |
...
!!! tip "Testers Wanted!"
    Help make Bambuddy work great with all Bambu Lab printers! If you have a P1 or A1 series printer, please [report your experience](https://github.com/maziggy/bambuddy/issues).
...
<br><br>
<img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fwiki.bambuddy.cool&count_bg=%2379C83D&title_bg=%23555555&icon=readthedocs&icon_color=%23E7E7E7&title=wiki%20visitors&edge_flat=true" alt="Wiki Visitors">
</div>
