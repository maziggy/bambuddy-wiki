...
| **Sensor Alert** | A [Home Assistant sensor](sensors.md) bound to a printer or storage location entered its alert state — an enclosure door opened, a chamber ran hot, a drybox got too humid. Fires on the transition in, not repeatedly. Off by default. |
